...
static inline void fe51_invert(fe51 *r, const fe51 *x)
{
	...
	/* 4 */ curve25519_sandy2x_fe51_nsquare(&t, &z2, 1);
	/* 8 */ curve25519_sandy2x_fe51_nsquare(&t, &t, 1);
	/* 9 */ curve25519_sandy2x_fe51_mul(&z9, &t, x);
	/* 11 */ curve25519_sandy2x_fe51_mul(&z11, &z9, &z2);
	/* 22 */ curve25519_sandy2x_fe51_nsquare(&t, &z11, 1);
	/* 2^5 - 2^0 = 31 */ curve25519_sandy2x_fe51_mul(&z2_5_0, &t, &z9);

	/* 2^10 - 2^5 */ curve25519_sandy2x_fe51_nsquare(&t, &z2_5_0, 5);
	/* 2^10 - 2^0 */ curve25519_sandy2x_fe51_mul(&z2_10_0, &t, &z2_5_0);

	/* 2^20 - 2^10 */ curve25519_sandy2x_fe51_nsquare(&t, &z2_10_0, 10);
	/* 2^20 - 2^0 */ curve25519_sandy2x_fe51_mul(&z2_20_0, &t, &z2_10_0);

	/* 2^40 - 2^20 */ curve25519_sandy2x_fe51_nsquare(&t, &z2_20_0, 20);
	/* 2^40 - 2^0 */ curve25519_sandy2x_fe51_mul(&t, &t, &z2_20_0);

	/* 2^50 - 2^10 */ curve25519_sandy2x_fe51_nsquare(&t, &t, 10);
	/* 2^50 - 2^0 */ curve25519_sandy2x_fe51_mul(&z2_50_0, &t, &z2_10_0);

	/* 2^100 - 2^50 */ curve25519_sandy2x_fe51_nsquare(&t, &z2_50_0, 50);
	/* 2^100 - 2^0 */ curve25519_sandy2x_fe51_mul(&z2_100_0, &t, &z2_50_0);

	/* 2^200 - 2^100 */ curve25519_sandy2x_fe51_nsquare(&t, &z2_100_0, 100);
	/* 2^200 - 2^0 */ curve25519_sandy2x_fe51_mul(&t, &t, &z2_100_0);

	/* 2^250 - 2^50 */ curve25519_sandy2x_fe51_nsquare(&t, &t, 50);
	/* 2^250 - 2^0 */ curve25519_sandy2x_fe51_mul(&t, &t, &z2_50_0);

	/* 2^255 - 2^5 */ curve25519_sandy2x_fe51_nsquare(&t, &t, 5);
	/* 2^255 - 21 */ curve25519_sandy2x_fe51_mul(r, &t, &z11);
}
